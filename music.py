...
class Sounds:
    ...
    @cache_wave("sqr")
    def square_wave(self, freq:float, dur:float, vol: float):
        ...
        self.existed_notes[name] = self.array_to_tuple(wave)
        return wave
    
    @cache_wave("tri")
    def triangle_wave(self, freq:float, dur:float, vol: float):
    ...
    @cache_wave("saw")
    def sawtooth_wave(self, freq:float, dur:float, vol: float):
    ...
    @cache_wave("revsaw")
    def reversed_sawtooth_wave(self, freq:float, dur:float, vol: float):
    ...
    @cache_wave("organ")
    def organ(self, freq:float, dur:float, vol: float):
    ...
    def array_to_tuple(self, np_array):
...
class Export:
    ...
    def get_sampwidth_from_str(self, dtype: str):
        match dtype:
            case "uint8":
                dtype = 1
            case "int16":
...
class Music(Sounds, Export):
    ...
    def init(self) -> None:
        ...
        self.stream = self.AUDIO_OBJECT.open(format=pyaudio.paFloat32,
                                             channels=1,
